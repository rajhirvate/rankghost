      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        >
          <Link href="/" className="flex items-center gap-2.5 group">
            <svg className="h-8 w-8 text-[#39ff14] drop-shadow-[0_0_8px_rgba(57,255,20,0.6)]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex flex-col leading-tight">
              <span className="font-display text-lg font-bold tracking-tight text-white">RankGhost</span>
              <span className="text-[10px] text-slate-500 tracking-wide">AI-Powered SEO Tracking</span>
            </div>
          </Link>

          <nav className="hidden items-center gap-8 text-base font-medium text-slate-400 md:flex">
            <Link href="#features" className="hover:text-[#39ff14] transition-colors">Features</Link>
            <Link href="#how-it-works" className="hover:text-[#39ff14] transition-colors">How it works</Link>
            <Link href="#pricing" className="hover:text-[#39ff14] transition-colors">Pricing</Link>
            <Link href="#faq" className="hover:text-[#39ff14] transition-colors">FAQ</Link>
          </nav>
          ...
          <div className="flex items-center gap-4">
            {user ? (
              <>
                ...
                <button
                  onClick={() => logout()}
                  className="rounded-full bg-white/5 px-5 py-2 text-sm font-medium text-white hover:bg-white/10 transition-all border border-white/10"
                >
                  Logout
                </button>
              </>
              ...
              <>
                <Link href="/login" className="hidden text-base font-medium text-slate-400 hover:text-[#39ff14] transition-colors sm:block">
                  Login
                </Link>
                <Link
                  href="/signup"
                  className="font-display rounded-full bg-[#39ff14] px-6 py-2.5 text-sm font-bold text-black shadow-[0_0_20px_rgba(57,255,20,0.5)] hover:scale-105 transition-all active:scale-95"
                >
                  Try for Free
                </Link>
              </>
