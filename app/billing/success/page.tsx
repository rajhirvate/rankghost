    ...
    <div className="min-h-screen bg-[#050505] flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        ...
        <div className="relative z-10">
          ...
          <h1 className="font-display text-3xl font-bold text-white mb-3">You&apos;re all set!</h1>
          <p className="text-slate-400 text-sm leading-relaxed mb-2">
            Your RankGhost subscription is now active. Head to your dashboard to start tracking keywords and monitoring AI citations.
          </p>
          <p className="text-slate-600 text-xs mb-8">
            Your plan may take a moment to reflect in the dashboard.
          </p>
