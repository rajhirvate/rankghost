...
const plans = [
  {
    ...
    name: "Starter",
    tier: "starter",
    monthly: { price: "9",  cents: ".99", note: "Billed monthly · No commitment",    planId: process.env.NEXT_PUBLIC_PAYPAL_PLAN_ID_STARTER_MONTHLY?.trim() ?? "" },
    yearly:  { price: "7",  cents: ".99", note: "Billed annually · Save $24/yr",     planId: process.env.NEXT_PUBLIC_PAYPAL_PLAN_ID_STARTER_ANNUAL?.trim()  ?? "" },
  ...
  },
  {
    ...
    name: "Pro",
    tier: "pro",
    monthly: { price: "24", cents: ".99", note: "Billed monthly · No commitment",    planId: process.env.NEXT_PUBLIC_PAYPAL_PLAN_ID_PRO_MONTHLY?.trim() ?? process.env.NEXT_PUBLIC_PAYPAL_PLAN_ID_MONTHLY?.trim() ?? "" },
    yearly:  { price: "19", cents: ".99", note: "Billed annually · Save $60/yr",     planId: process.env.NEXT_PUBLIC_PAYPAL_PLAN_ID_PRO_ANNUAL?.trim()  ?? process.env.NEXT_PUBLIC_PAYPAL_PLAN_ID_ANNUAL?.trim()  ?? "" },
  ...
  },
  {
    ...
    name: "Agency",
    tier: "agency",
    monthly: { price: "69", cents: ".99", note: "Billed monthly · No commitment",    planId: process.env.NEXT_PUBLIC_PAYPAL_PLAN_ID_AGENCY_MONTHLY?.trim() ?? "" },
    yearly:  { price: "55", cents: ".99", note: "Billed annually · Save $168/yr",    planId: process.env.NEXT_PUBLIC_PAYPAL_PLAN_ID_AGENCY_ANNUAL?.trim()  ?? "" },
