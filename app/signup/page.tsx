    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex w-full lg:w-1/2 flex-col items-center justify-center bg-white px-8 py-16">
        <div className="w-full max-w-md">
          <h2 className="font-display text-3xl font-normal text-slate-900 mb-2">Create your account</h2>
          <p className="text-slate-500 text-sm mb-8">Start your free trial. No credit card required.</p>
          <AuthForm mode="signup" />
          <p className="mt-6 text-center text-sm text-slate-500">
            Already have an account?{" "}
            <Link href="/login" className="text-[#39ff14] font-semibold hover:underline" style={{color: "#1a9e00"}}>
              Sign in
            </Link>
          </p>
        </div>
